...
function HomeDiseño() {
  ...
  return (
    <div>
      ...
      {state === 1 ? (
        ...
        <header className="header-diseño">
          ...
          <div className="text-box">
            ...
            <Link className="btn-diseño" onClick={onChangeState1}>
              Atras
            </Link>
          </div>
        </header>
      ...
      {state === 1 ? (
        <section className="body-card-diseño">
          ...
          <div className="card-container-diseño">
            <div className="card-diseño" onClick={onChangeState3}>
              <img
              ...
              <div className="card-text-diseño">
                <button className="button-card-diseño" onClick={onChangeState3}>
                  Diseñar
                </button>
              </div>
            </div>

            <div className="card-diseño" onClick={onChangeState4}>
              <img
              ...
              <div className="card-text-diseño">
                <button className="button-card-diseño" onClick={onChangeState4}>
                  Diseñar
                </button>
              </div>
            </div>

            <div className="card-diseño" onClick={onChangeState2}>
              <img
                src={buzoCanguroFrenteContorno}
                alt="Diseño"
                className="img-card-diseño"
              />

              <div className="card-text-diseño">
                <button className="button-card-diseño" onClick={onChangeState2}>
                  Diseñar
                </button>
              </div>
            </div>

            <div className="card-diseño" onClick={onChangeState5}>
              <img
              ...
              <div className="card-text-diseño">
                <button className="button-card-diseño" onClick={onChangeState5}>
                  Diseñar
                </button>
              </div>
            </div>
      ...
      {state === 2 ? <Diseño1 /> : null}

      {state === 3 ? <Diseño2 /> : null}

      {state === 4 ? <Diseño3 /> : null}

      {state === 5 ? <Diseño4 /> : null}
